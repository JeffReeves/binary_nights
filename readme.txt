...
Binary_Nights WordPress Theme, Copyright Cryout Creations - https://www.cryoutcreations.eu/
Licensed under GPLv3 (http://www.gnu.org/licenses/gpl.html)

Binary_Nights WordPress Theme bundles the following third-party resources:
...
* Imported Esotera theme as a base to create binary_nights theme
* Updated readme.txt
